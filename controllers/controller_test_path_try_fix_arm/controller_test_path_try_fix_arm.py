...
robot_chain = Chain.from_urdf_file("LRMate-200iD_try_fix_arm_itri.urdf",base_elements=['Base'])
...
#     base_node.getField('translation').setSFVec3f([0.0, -0.0804225935, 0.0])
    ...
    j6_node = supervisor.getFromDef("LRMate200iD")
    ...
    cal_pos=get_endpoint_position(angles[:1])
    ...
    if _ >30:
        ...
        # print("j6_pos",j6_pos)
        print("error_j6",j6_pos-np.array([cal_pos[0][3],cal_pos[1][3],cal_pos[2][3]]))
